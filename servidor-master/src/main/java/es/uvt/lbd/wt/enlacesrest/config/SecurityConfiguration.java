...
import es.uvt.lbd.wt.enlacesrest.security.MyAccessDeniedHandler;
import es.uvt.lbd.wt.enlacesrest.security.MyUnauthorizedEntryPoint;
import es.uvt.lbd.wt.enlacesrest.security.MyUserDetailsService;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http.csrf().disable().exceptionHandling()
      ...
      .antMatchers(HttpMethod.GET, "/api/enlaces/**/image").permitAll()
